 <!-- BEGIN: Header -->
 <!-- BEGIN: Header -->
 <div class="z-[99] sticky top-0" id="app_header">
     <div
         class="app-header z-[999] ltr:xl:ml-[248px] rtl:xl:mr-[248px] ltr:ml-0 rtl:mr-0 bg-white dark:bg-slate-800 shadow-sm dark:shadow-slate-700">
            ...
            dark:text-white font-normal">
                             ...
                             <li>
                                 <form action="{{ route('logout') }}" method="post">
                                    @csrf
                                    <button class="block px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600 dark:hover:text-white font-inter text-sm text-slate-600
            dark:text-white font-normal">
