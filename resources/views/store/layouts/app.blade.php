...
<head>
    ...
    <meta name="description"
        content="Aksara Coffee & Eatery - Nikmati sajian kopi pilihan, aneka bakes segar, dan hidangan istimewa langsung dari cafe kami.">
    ...
    <link rel="stylesheet" href="{{ asset('store/css/swiper-bundle.min.css') }}">
...
<body>
        ...
        <div class="canvas-body">
            ...
            <div class="payment-wrap">
                ...
                <ul class="payment-method-list">
                    <li><img src="{{ asset('store/images/payment/visa.png') }}" alt="Payment"></li>
                    <li><img src="{{ asset('store/images/payment/master-card.png') }}" alt="Payment"></li>
                    <li><img src="{{ asset('store/images/payment/amex.png') }}" alt="Payment"></li>
                    <li><img src="{{ asset('store/images/payment/discover.png') }}" alt="Payment"></li>
                    <li><img src="{{ asset('store/images/payment/paypal.png') }}" alt="Payment"></li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="tf-compare-offcanvas list-empty">
                            ...
                            <div class="tf-compare-item file-delete">
                                <a href="product-detail.html">
                                    ...
                                    <img class="radius-3 lazyload" data-src="{{ asset('store/images/products/shoes/product-8.jpg') }}"
                                        src="{{ asset('store/images/products/shoes/product-8.jpg') }}" alt="">
                                </a>
                            </div>
                            <div class="tf-compare-item file-delete">
                                <a href="product-detail.html">
                                    ...
                                    <img class="radius-3 lazyload" data-src="{{ asset('store/images/products/shoes/product-11.jpg') }}"
                                        src="{{ asset('store/images/products/shoes/product-11.jpg') }}" alt="">
                                </a>
                            </div>
                            <div class="tf-compare-item file-delete">
                                <a href="product-detail.html">
                                    ...
                                    <img class="radius-3 lazyload" data-src="{{ asset('store/images/products/shoes/product-15.jpg') }}"
                                        src="{{ asset('store/images/products/shoes/product-15.jpg') }}" alt="">
                                </a>
                            </div>
                        </div>
                    ...
                    <div dir="ltr" class="swiper tf-single-slide">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide" data-size="XS" data-color="beige">
                                <div class="item">
                                    <img class="lazyload" data-src="{{ asset('store/images/products/shoes/product-1.jpg') }}" src="{{ asset('store/images/products/shoes/product-1.jpg') }}"
                                        alt="">
                                </div>
                            </div>
                            <div class="swiper-slide" data-size="L" data-color="pink">
                                <div class="item">
                                    <img class="lazyload" data-src="{{ asset('store/images/products/shoes/product-5.jpg') }}" src="{{ asset('store/images/products/shoes/product-5.jpg') }}"
                                        alt="">
                                </div>
                            </div>
                            <div class="swiper-slide" data-size="M" data-color="green">
                                <div class="item">
                                    <img class="lazyload" data-src="{{ asset('store/images/products/shoes/product-3.jpg') }}" src="{{ asset('store/images/products/shoes/product-3.jpg') }}"
                                        alt="">
                                </div>
                            </div>
                            <div class="swiper-slide" data-size="S" data-color="blue">
                                <div class="item">
                                    <img class="lazyload" data-src="{{ asset('store/images/products/shoes/product-4.jpg') }}" src="{{ asset('store/images/products/shoes/product-4.jpg') }}"
                                        alt="">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="trend-product-inner">
                        <div class="trend-product-list">
                            <div class="trend-product-item">
                                <div class="image">
                                    <img class="lazyload" src="{{ asset('store/images/products/shoes/product-1.jpg') }}" data-src="{{ asset('store/images/products/shoes/product-1.jpg') }}"
                                        alt="Product">
                                </div>
                                <div class="content">
                            ...
                            <div class="trend-product-item">
                                <div class="image">
                                    <img class="lazyload" src="{{ asset('store/images/products/shoes/product-3.jpg') }}" data-src="{{ asset('store/images/products/shoes/product-3.jpg') }}"
                                        alt="Product">
                                </div>
                                <div class="content">
                        ...
                        <div class="trend-product-list">
                            <div class="trend-product-item">
                                <div class="image">
                                    <img class="lazyload" src="{{ asset('store/images/products/shoes/product-4.jpg') }}" data-src="{{ asset('store/images/products/shoes/product-4.jpg') }}"
                                        alt="Product">
                                </div>
                                <div class="content">
                            ...
                            <div class="trend-product-item">
                                <div class="image">
                                    <img class="lazyload" src="{{ asset('store/images/products/shoes/product-7.jpg') }}" data-src="{{ asset('store/images/products/shoes/product-7.jpg') }}"
                                        alt="Product">
                                </div>
                                <div class="content">
            ...
            <div class="wrap-recommendations">
                <div class="list-cart">
                    <div class="list-cart-item">
                        <div class="image">
                            <img class="lazyload" data-src="{{ asset('store/images/products/shoes/product-5.jpg') }}" src="{{ asset('store/images/products/shoes/product-5.jpg') }}" alt="">
                        </div>
                        <div class="content">
                            <h6 class="name">
                    ...
                    <div class="list-cart-item">
                        <div class="image">
                            <img class="lazyload" data-src="{{ asset('store/images/products/shoes/product-1.jpg') }}" src="{{ asset('store/images/products/shoes/product-1.jpg') }}" alt="">
                        </div>
                        <div class="content">
                            <h6 class="name">
                    ...
                    <div class="list-cart-item">
                        <div class="image">
                            <img class="lazyload" data-src="{{ asset('store/images/products/shoes/product-3.jpg') }}" src="{{ asset('store/images/products/shoes/product-3.jpg') }}" alt="">
                        </div>
                        <div class="content">
                            <h6 class="name">
                    ...
                    <div class="list-cart-item">
                        <div class="image">
                            <img class="lazyload" data-src="{{ asset('store/images/products/shoes/product-4.jpg') }}" src="{{ asset('store/images/products/shoes/product-4.jpg') }}" alt="">
                        </div>
                        <div class="content">
                            <h6 class="name">
                            ...
                            <div class="tf-mini-cart-items list-empty">
                                ...
                                <div class="tf-mini-cart-item file-delete">
                                    <div class="tf-mini-cart-image">
                                        <img class="lazyload" data-src="{{ asset('store/images/products/shoes/product-7.jpg') }}" src="{{ asset('store/images/products/shoes/product-7.jpg') }}"
                                            alt="img-product">
                                    </div>
                                ...
                                <div class="tf-mini-cart-item file-delete">
                                    <div class="tf-mini-cart-image">
                                        <img class="lazyload" data-src="{{ asset('store/images/products/shoes/product-13.jpg') }}"
                                            src="{{ asset('store/images/products/shoes/product-13.jpg') }}" alt="img-product">
                                    </div>
                                    <div class="tf-mini-cart-info">
                                        <div class="text-small text-main-2 sub">T-shirt</div>
                                        <h6 class="title">
                                ...
                                <div class="tf-mini-cart-item file-delete">
                                    <div class="tf-mini-cart-image">
                                        <img class="lazyload" data-src="{{ asset('store/images/products/shoes/product-15.jpg') }}"
                                            src="{{ asset('store/images/products/shoes/product-15.jpg') }}" alt="img-product">
                                    </div>
                                    <div class="tf-mini-cart-info">
                                        <div class="text-small text-main-2 sub">Sweatshirt</div>
                                        <h6 class="title">
                                ...
                                <div class="tf-mini-cart-item file-delete">
                                    <div class="tf-mini-cart-image">
                                        <img class="lazyload" data-src="{{ asset('store/images/products/shoes/product-21.jpg') }}"
                                            src="{{ asset('store/images/products/shoes/product-21.jpg') }}" alt="img-product">
                                    </div>
                                    <div class="tf-mini-cart-info">
                                        <div class="text-small text-main-2 sub">Shorts</div>
                                        <h6 class="title">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="mega-menu">
                    <div class="row-demo">
                        <div class="demo-item">
                            <a href="index.html" class="demo-img"><img src="{{ asset('store/images/demo/home-fashion-1.jpg') }}" alt="Demo"></a>
                            <a href="index.html" class="demo-name">Home Fashion 1</a>
                        </div>
                        <div class="demo-item">
                            <a href="home-fashion-2.html" class="demo-img"><img src="{{ asset('store/images/demo/home-fashion-2.jpg') }}" alt="Demo"></a>
                            <a href="home-fashion-2.html" class="demo-name">Home Fashion 2</a>
                        </div>
                        <div class="demo-item">
                            <a href="home-fashion-3.html" class="demo-img"><img src="{{ asset('store/images/demo/home-fashion-3.jpg') }}" alt="Demo"></a>
                            <a href="home-fashion-3.html" class="demo-name">Home Fashion 3</a>
                        </div>
                        <div class="demo-item">
                            <a href="home-fashion-4.html" class="demo-img"><img src="{{ asset('store/images/demo/home-fashion-4.jpg') }}" alt="Demo"></a>
                            <a href="home-fashion-4.html" class="demo-name">Home Fashion 4</a>
                        </div>
                        <div class="demo-item">
                            <a href="home-cosmetic.html" class="demo-img"><img src="{{ asset('store/images/demo/home-cosmetic.jpg') }}" alt="Demo"></a>
                            <a href="home-cosmetic.html" class="demo-name">Home Cosmetic</a>
                        </div>
                        <div class="demo-item">
                            <a href="home-skin-care.html" class="demo-img"><img src="{{ asset('store/images/demo/home-skin-care.jpg') }}" alt="Demo"></a>
                            <a href="home-skin-care.html" class="demo-name">Home Skincare</a>
                        </div>
                        <div class="demo-item">
                            <a href="home-decor.html" class="demo-img"><img src="{{ asset('store/images/demo/home-decor.jpg') }}" alt="Demo"></a>
                            <a href="home-decor.html" class="demo-name">Home Decor</a>
                        </div>
                        <div class="demo-item">
                            <a href="home-jewelry.html" class="demo-img"><img src="{{ asset('store/images/demo/home-jewelry.jpg') }}" alt="Demo"></a>
                            <a href="home-jewelry.html" class="demo-name">Home Jewelry</a>
                        </div>
                        <div class="demo-item">
                            <a href="home-electronic-market.html" class="demo-img"><img src="{{ asset('store/images/demo/home-electronic-market.jpg') }}" alt="Demo"></a>
                            <a href="home-electronic-market.html" class="demo-name">Home
                                Electric Market</a>
                        </div>
                        <div class="demo-item">
                            <a href="home-pet-store.html" class="demo-img"><img src="{{ asset('store/images/demo/home-pet-store.jpg') }}" alt="Demo"></a>
                            <a href="home-pet-store.html" class="demo-name">Home Pet Store</a>
                        </div>
                        <div class="demo-item">
                            <a href="home-sneaker.html" class="demo-img"><img src="{{ asset('store/images/demo/home-sneaker.jpg') }}" alt="Demo"></a>
                            <a href="home-sneaker.html" class="demo-name">Home Sneaker</a>
                        </div>
                        <!-- New -->
                        <div class="demo-item">
                            <a href="home-book.html" class="demo-img">
                                <img class="lazyload" src="{{ asset('store/images/demo/home-book.jpg') }}" data-src="{{ asset('store/images/demo/home-book.jpg') }}" alt="Demo">
                        ...
                        <div class="demo-item">
                            <a href="home-organic.html" class="demo-img">
                                <img class="lazyload" src="{{ asset('store/images/demo/home-organic.jpg') }}" data-src="{{ asset('store/images/demo/home-organic.jpg') }}" alt="Demo">
                                <div class="demo-label">
                                    <span>New</span>
                                </div>
                            </a>
                        ...
                        <div class="demo-item">
                            <a href="home-medical.html" class="demo-img">
                                <img class="lazyload" src="{{ asset('store/images/demo/home-medical.jpg') }}" data-src="{{ asset('store/images/demo/home-medical.jpg') }}" alt="Demo">
                                <div class="demo-label">
                                    <span>New</span>
                                </div>
                            </a>
                        ...
                        <div class="demo-item">
                            <a href="home-gym.html" class="demo-img">
                                <img class="lazyload" src="{{ asset('store/images/demo/home-gym.jpg') }}" data-src="{{ asset('store/images/demo/home-gym.jpg') }}" alt="Demo">
                                <div class="demo-label">
                                    <span>New</span>
                                </div>
                            </a>
                        ...
                        <div class="demo-item">
                            <a href="home-art.html" class="demo-img">
                                <img class="lazyload" src="{{ asset('store/images/demo/home-art.jpg') }}" data-src="{{ asset('store/images/demo/home-art.jpg') }}" alt="Demo">
                                <div class="demo-label">
                                    <span>New</span>
                                </div>
                            </a>
                        ...
                        <div class="demo-item">
                            <a href="home-accessories.html" class="demo-img">
                                <img class="lazyload" src="{{ asset('store/images/demo/home-accessories.jpg') }}" data-src="{{ asset('store/images/demo/home-accessories.jpg') }}" alt="Demo">
                                <div class="demo-label">
                                    <span>New</span>
                                </div>
                            </a>
                        ...
                        <div class="demo-item">
                            <a href="home-car-auto.html" class="demo-img">
                                <img class="lazyload" src="{{ asset('store/images/demo/home-car-auto.jpg') }}" data-src="{{ asset('store/images/demo/home-car-auto.jpg') }}" alt="Demo">
                                <div class="demo-label">
                                    <span>New</span>
                                </div>
                            </a>
                        ...
                        <div class="demo-item">
                            <a href="home-travel.html" class="demo-img">
                                <img class="lazyload" src="{{ asset('store/images/demo/home-travel.jpg') }}" data-src="{{ asset('store/images/demo/home-travel.jpg') }}" alt="Demo">
                                <div class="demo-label">
                                    <span>New</span>
                                </div>
                            </a>
                        ...
                        <div class="demo-item">
                            <a href="home-watch.html" class="demo-img">
                                <img class="lazyload" src="{{ asset('store/images/demo/home-watch.jpg') }}" data-src="{{ asset('store/images/demo/home-watch.jpg') }}" alt="Demo">
                                <div class="demo-label">
                                    <span>New</span>
                                </div>
                            </a>
    ...
    <script src="{{ asset('store/js/swiper-bundle.min.js') }}"></script>
    <script src="{{ asset('store/js/carousel.js') }}"></script>
    <script src="{{ asset('store/js/bootstrap-select.min.js') }}"></script>
    <script src="{{ asset('store/js/lazysize.min.js') }}"></script>
    <script src="{{ asset('store/js/wow.min.js') }}"></script>
    <script src="{{ asset('store/js/infinityslide.js') }}"></script>
    <script src="{{ asset('store/js/parallaxie.js') }}"></script>
    <script src="{{ asset('store/js/count-down.js') }}"></script>
    <script src="{{ asset('store/js/main.js') }}"></script>

    <script src="{{ asset('store/js/sibforms.js') }}" defer></script>
    <script>
